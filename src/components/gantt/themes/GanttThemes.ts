...
export const ganttThemes: GanttTheme[] = [
  ...
  },
  {
    ...
    cssVariables: {
      ...
      '--shadow-active':
        'inset 0 1px 0 rgba(255, 255, 255, 0.2), inset 0 -1px 0 rgba(0, 0, 0, 0.25)',
  ...
  },
  {
    ...
    cssVariables: {
      ...
      '--border-dark': '#c7c7cc',
      '--shadow-inset':
        'inset 0 0.5px 0 rgba(255, 255, 255, 0.9), inset 0 -0.5px 0 rgba(0, 0, 0, 0.08)',
  ...
  },
  {
    ...
    preview:
      'linear-gradient(135deg, rgba(255,255,255,0.8) 0%, rgba(200,220,255,0.6) 50%, rgba(255,255,255,0.9) 100%)',
    cssVariables: {
      ...
      '--bg-active':
        'linear-gradient(135deg, rgba(0, 122, 255, 0.95) 0%, rgba(0, 100, 220, 0.95) 100%)',
      '--bg-active-hover':
        'linear-gradient(135deg, rgba(0, 140, 255, 0.95) 0%, rgba(0, 110, 230, 0.95) 100%)',
      '--bg-active-pressed':
        'linear-gradient(135deg, rgba(0, 100, 220, 0.95) 0%, rgba(0, 80, 200, 0.95) 100%)',
      ...
      '--shadow-active':
        '0 8px 24px rgba(0, 122, 255, 0.25), 0 4px 8px rgba(0, 0, 0, 0.1), inset 0 1px 1px rgba(255, 255, 255, 0.5)',
      ...
      '--glass-reflection':
        'linear-gradient(180deg, rgba(255,255,255,0.5) 0%, rgba(255,255,255,0.1) 60%, transparent 100%)',
    },
  },
]

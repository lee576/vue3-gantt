...
export class LinkConfigManager {
  ...
  private deepMergeConfig(source: Partial<LinkConfig>): void {
    ...
    if (source.linkTypeVisibility && this.config.linkTypeVisibility) {
      ...
      if (v.finishToStart !== undefined)
        this.config.linkTypeVisibility.finishToStart = v.finishToStart
      if (v.startToStart !== undefined) this.config.linkTypeVisibility.startToStart = v.startToStart
      if (v.finishToFinish !== undefined)
        this.config.linkTypeVisibility.finishToFinish = v.finishToFinish
      if (v.startToFinish !== undefined)
        this.config.linkTypeVisibility.startToFinish = v.startToFinish
    ...
    if (source.linkTypeColors && this.config.linkTypeColors) {
      ...
      if (c.finishToFinish !== undefined)
        this.config.linkTypeColors.finishToFinish = c.finishToFinish

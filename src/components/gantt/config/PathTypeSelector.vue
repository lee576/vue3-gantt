    ...
    const pathTypes = computed(() => [
      {
        ...
        name: t('configPanel.linkConfig.straight'),
        preview: 'M 10 20 L 50 20',
      },
      {
        value: LinkPathType.BEZIER,
        name: t('configPanel.linkConfig.bezier'),
        preview: 'M 10 25 Q 30 5 50 25',
      },
      {
        value: LinkPathType.RIGHT_ANGLE,
        name: t('configPanel.linkConfig.rightAngle'),
        preview: 'M 10 15 L 25 15 L 25 25 L 50 25',
      },
    ])
